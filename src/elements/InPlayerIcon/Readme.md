...
<Grid.Container>
  <Grid.Cell>
    ...
    <InPlayerIcon name="donate"/>
	</Tooltip>
  </Grid.Cell>
  <Grid.Cell>
	<Tooltip content="Required">
    <InPlayerIcon name="required"/>
	</Tooltip>
  </Grid.Cell>
    <Grid.Cell>
  ...
  <Grid.Cell>
    ...
    <InPlayerIcon name="arrRight"/>
	</Tooltip>
  </Grid.Cell>
    <Grid.Cell>
	<Tooltip content="Library">
    <InPlayerIcon name="library"/>
	</Tooltip>
  </Grid.Cell>
  <Grid.Cell>
	<Tooltip content="Asset Many">
    <InPlayerIcon name="assetMany"/>
	</Tooltip>
  </Grid.Cell>
    <Grid.Cell>
	<Tooltip content="Asset One">
    <InPlayerIcon name="assetOne"/>
	</Tooltip>
  </Grid.Cell>
  <Grid.Cell>
